...
Создаваемая система, которой я пока дал рабочее название *Project S* — это мой пет-проект и эксперимент в области инвестиционной аналитики а также искусственного интеллекта.  
